...
#import "DPCPickerColumnCell.h"
#import "DPCPickerTableView.h"

@interface DPCPickerColumnView()<UITableViewDelegate, UITableViewDataSource>
...
@property (nonatomic, weak) DPCPickerTableView *upTableView;
@property (nonatomic, weak) DPCPickerTableView *centerTableView;
@property (nonatomic, weak) DPCPickerTableView *downTableView;
...
@implementation DPCPickerColumnView

#define kWidth self.frame.size.width
#define kHeight self.frame.size.height

static NSString *const cellReuseIdentifier = @"DPCPickerColumnCell";
...
- (void)setupTableView {
    {
        ...
        DPCPickerTableView *tableView = [[DPCPickerTableView alloc]initWithFrame:frame style:UITableViewStylePlain];
        [tableView registerClass:[DPCPickerColumnCell class] forCellReuseIdentifier:cellReuseIdentifier];
...
- (void)scrollViewDidScroll:(UITableView *)tableView {
    ...
    if (tableView == self.downTableView) {
        ...
        if (!self.isHiddenWheels) {
            [tableView.visibleCells enumerateObjectsUsingBlock:^(__kindof DPCPickerColumnCell * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    DPCPickerColumnCell *cell = [tableView dequeueReusableCellWithIdentifier:cellReuseIdentifier];
